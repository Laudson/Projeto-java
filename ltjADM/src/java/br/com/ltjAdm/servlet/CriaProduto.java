    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (sessao.getAttribute("nomeCompleto") == null) {
            ...
            try {
                ...
                String comandoSQL = "insert into produto_principal(nome_produto, cod_grp_prod, cod_cate_prod,bloq_produto) values "
                        + "('" + request.getParameter("cadasNomeProd").trim() + "',"
                        + "'" + request.getParameter("cadasGrupoProd").trim() + "',"
                        + "'" + request.getParameter("cadasCateProd").trim() + "','N')";
